...
const CONTENT = [
  ...
  { page: 'for-investors', section: 'why-us', order: 2, badge: '02', title: 'Your Goals Come First. Opportunities Come Second.', subtitle: "A 500-option listing is not alignment. It's homework. XPAND doesn't hand you a catalogue and walk away. We understand your investment goals, sector preference, capital appetite, and growth horizon — then align you with franchise opportunities built around your commercial intent. Right sector. Right model. Right market. Right fit. Because at this stage of your journey, your time is the most valuable asset in the room." },
  ...
  { page: 'about', section: 'focus-areas', order: 1, tag: 'YOU COME TO US', title: 'We Understand Your Business',      items: ['Business model', 'Expansion vision', 'Funding requirements', 'Target cities', 'Scalability potential'] },
  { page: 'about', section: 'focus-areas', order: 2, tag: 'WE MAP',         title: 'Expansion Needs Analysis',        items: ['Market opportunities', 'City-wise potential', 'Investor fit', 'Commercial viability', 'Rollout strategy'] },
  { page: 'about', section: 'focus-areas', order: 3, tag: 'WE PREPARE',     title: 'Investor-Ready Positioning',      items: ['Business proposals', 'Franchise frameworks', 'Expansion positioning', 'Commercial narratives', 'Structured presentations'] },
  { page: 'about', section: 'focus-areas', order: 4, tag: 'WE CONNECT',     title: 'Qualified Investor Matchmaking',  items: ['Lead-gen systems', 'Investor network access', 'Telesales counseling', 'Investor alignment', 'Franchise matching'] },
  { page: 'about', section: 'focus-areas', order: 5, tag: 'WE CLOSE',       title: 'Deal Support Till Closure',       items: ['Investor coordination', 'Execution support', 'Commercial discussions', 'Closure facilitation', 'Scalable growth'] },
];
